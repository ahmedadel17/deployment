            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="product-rate flex items-center space-x-4">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm text-gray-600 dark:text-gray-400 ml-2 rtl:ml-0 rtl:mr-2">4.2 (89 reviews)</span>
                        </div>
                ...
                <div class="product-meta text-sm text-gray-600 dark:text-gray-400 space-y-2">
                    ...
                    <p>
                        ...
                        <a href="/category/clothing" class="text-primary-600 dark:text-primary-200 hover:underline">Clothing</a>
                    </p>
                    <p>
                        <span class="font-medium text-gray-900 dark:text-white">Tags:</span>
                        <a href="/tag/shorts" class="text-primary-600 dark:text-primary-200 hover:underline">Shorts</a>,
                        <a href="/tag/chino" class="text-primary-600 dark:text-primary-200 hover:underline">Chino</a>,
                        <a href="/tag/casual" class="text-primary-600 dark:text-primary-200 hover:underline">Casual</a>,
                        <a href="/tag/men" class="text-primary-600 dark:text-primary-200 hover:underline">Men</a>
                    </p>
                </div>
