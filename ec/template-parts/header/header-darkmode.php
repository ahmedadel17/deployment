<div class="flex items-center">
    <button id="darkModeToggle" class="te-navbar-icon-button" aria-label="Toggle Dark Mode">
        ...
        <!-- Sun Icon -->
        <div class="sun absolute  w-6 h-6 text-amber-500 opacity-100 rotate-0 dark:opacity-0 dark:rotate-180">
        ...
        <!-- Moon Icon -->
        <div class="moon absolute w-6 h-6 text-slate-300 opacity-0 dark:opacity-100 dark:rotate-0 scale-75">
