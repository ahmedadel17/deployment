<div class="te-navbar-dropdown">
    <a href="dashboard-notification.php" class="header-notification relative flex items-center gap-3 cursor-pointer">
        <div class="cart-icon">
            <div class="w-10 h-10 bg-gray-100 dark:bg-gray-900 flex justify-center items-center rounded-full relative">
                ...
                <!-- Badge -->
                <span class="header-notification-item absolute -top-1 -right-1 bg-primary-200 text-white text-xs rounded-full w-4 h-4 flex items-center justify-center leading-none">
                    5
                </span>
            </div>
        </div>
