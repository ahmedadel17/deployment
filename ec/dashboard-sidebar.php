...
$menu_items = [
    ...
    [
        ...
        'url'   => 'dashboard-notification.php',
    ],
    [
        'title' => 'My Rewards',
...
<div class="lg:col-span-1">
    <div class="sticky top-8 space-y-6">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <!-- User Profile -->
            <div class="flex items-center mb-6 pb-6 border-b border-gray-200 dark:border-gray-600">
                <div class="w-16 h-16 bg-primary-600 dark:bg-primary-300 rounded-full flex items-center justify-center text-white font-semibold text-lg">
                    JD
                </div>
                <div class="ms-4">
            ...
            <nav class="space-y-1">
                ...
                ?>
                    <a href="<?= $item['url'] ?>" class="flex gap-3 items-center px-3 py-2 text-sm font-medium rounded-md <?= $active_class ?>">
